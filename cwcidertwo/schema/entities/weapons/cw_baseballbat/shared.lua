...
if (SERVER) then
	...
	Clockwork.kernel:AddFile("materials/models/weapons/baseball_bat/metal_bat.vtf");
	Clockwork.kernel:AddFile("materials/models/weapons/baseball_bat/metal_bat.vmt");
	Clockwork.kernel:AddDirectory("models/weapons/v_basball.*");
	Clockwork.kernel:AddDirectory("models/weapons/w_basball.*");
end;
