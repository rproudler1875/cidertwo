...
local ITEM = Clockwork.item:New("vehicle_base");
	ITEM.name = "Blue Corvette";
	ITEM.cost = 12000;
	ITEM.class = "prop_vehicle_jeep";
	ITEM.model = "models/corvette/corvette.mdl";
	ITEM.seatType = "Seat_Jeep";
	ITEM.uniqueID = "corvette";
	ITEM.hideSeats = true;
	ITEM.description = "It's a blue Corvette, a pretty sweet ride.";
	ITEM.vehiclePhysDesc = "A blue, fast and sexy car.";
